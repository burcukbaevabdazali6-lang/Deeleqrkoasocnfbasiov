...
local Tabs = {
    Home = Window:CreateTab("Home", true, "170940874"),
    Grab = Window:CreateTab("Grab", true, "17313313998"),
	Defense = Window:CreateTab("Defense", true, "16069233190"),
	Target = Window:CreateTab("Target", true, "107058246184363"),
    Blobmen = Window:CreateTab("Blobmen", true, "109717244852381"),
	Player = Window:CreateTab("Player", true, "124871982298256"),
    Visuals  = Window:CreateTab("Visuals",  true, "78134819718605"),
	Misc = Window:CreateTab("Misc", true, "114167292947807"),
    Server  = Window:CreateTab("Server",  true, "9692125126"),
	Keybinds = Window:CreateTab("Keybinds", true, "11710306232"),
}

-- Server Tab Groups
local ServerLines = Tabs.Server:CreateBlock({Name = "Lines", Side = "Left"})
local ServerPackets = Tabs.Server:CreateBlock({Name = "Packets", Side = "Left"})
local ServerAll = Tabs.Server:CreateBlock({Name = "All", Side = "Right"})
...
GrabGroup:CreateToggle({
	...
	Default = false,
	Callback = function(Value)
		SetToggleState("Kick Grab", Value)
		kickGrabEnabled = Value
		if Value then
			startKickGrab()
		else
			if kickGrabConnection then
